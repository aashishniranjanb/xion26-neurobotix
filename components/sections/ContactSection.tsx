    ...
    return (
        <section className="relative py-12 xs:py-16 sm:py-20 md:py-28 bg-[#020202] text-yellow-500 overflow-hidden">
            ...
            <div className="relative w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 md:px-12">
                    ...
                    >
                        <HoverTiltCard>
                            <div className="gold-sweep relative border border-yellow-500/20 rounded-xl p-4 xs:p-5 sm:p-6 bg-[#0A0A0A]/60 sm:backdrop-blur-md hover:border-yellow-400/40 transition-colors duration-300">
                                ...
                                <span className="inline-block px-2 py-0.5 text-[10px] xs:text-xs bg-yellow-500/10 border border-yellow-500/20 rounded-full text-yellow-400 tracking-widest uppercase mb-1 xs:mb-1.5 sm:mb-2">
                                    Primary Contact
                                </span>
                                ...
                                <div className="flex gap-2 xs:gap-3 mt-2 xs:mt-3 flex-wrap">
                                    ...
                                    <MagneticButton
                                        ...
                                        className="min-h-[46px] w-full flex items-center justify-center gap-1.5 px-4 py-2.5 text-[12px] xs:text-sm border border-yellow-500/30 rounded-lg hover:bg-yellow-500/10 active:bg-yellow-500/15 transition text-yellow-500 font-bold"
                                    >
                        ...
                        <HoverTiltCard>
                            <div className="gold-sweep relative border border-yellow-500/20 rounded-xl p-4 xs:p-5 sm:p-6 bg-[#0A0A0A]/60 sm:backdrop-blur-md hover:border-yellow-400/40 transition-colors duration-300 h-full">
                                ...
                                <p className="text-[12px] xs:text-sm text-yellow-300 leading-relaxed font-medium">
                                    ...
                                    <br />
                                    <span className="text-yellow-300/80 font-normal">
                                        (100 Feet Road)
                                    </span>
                                    <br />
                                ...
                                <MagneticButton
                                    ...
                                    target="_blank"
                                    className="inline-flex items-center gap-1.5 min-h-[44px] mt-3 xs:mt-4 sm:mt-6 px-4 xs:px-5 py-2 xs:py-2.5 text-[11px] xs:text-xs sm:text-sm bg-gradient-to-r from-yellow-500 to-yellow-700 text-black font-semibold rounded-md hover:opacity-90 active:opacity-80 shadow-lg transition"
                                >
                            ...
                            <div className="gold-sweep relative border border-yellow-500/20 rounded-xl p-4 xs:p-5 sm:p-6 bg-[#0A0A0A]/60 sm:backdrop-blur-md hover:border-yellow-400/40 transition-colors duration-300 h-full">
                                ...
                                <div className="space-y-3 xs:space-y-4">
                                    <Link
                                        ...
                                        target="_blank"
                                        className="block min-h-[40px] flex items-center gap-2 text-[12px] xs:text-sm text-yellow-400/90 hover:text-yellow-300 active:text-yellow-200 transition underline underline-offset-4 decoration-yellow-500/30 font-semibold"
                                    >
                                    ...
                                    <Link
                                        ...
                                        target="_blank"
                                        className="block min-h-[40px] flex items-center gap-2 text-[12px] xs:text-sm text-yellow-400/90 hover:text-yellow-300 active:text-yellow-200 transition font-semibold"
                                    >
                ...
                >
                    <h3 className="text-lg xs:text-xl sm:text-2xl font-bold mb-3 xs:mb-4 sm:mb-5 tracking-wide uppercase">
                        Transmit Message
                    </h3>
                    <p className="text-zinc-200/80 text-[12px] xs:text-sm mb-6 xs:mb-8 md:mb-10 leading-relaxed font-medium">
                        <br className="hidden sm:block" />
                        <span className="text-yellow-500 font-bold mt-2 inline-block">RESPONSE TIME: WITHIN 24 HOURS.</span>
                    </p>
                    ...
                    <MagneticButton
                        ...
                        href="/404"
                        target="_blank"
                        className="inline-flex items-center justify-center min-h-[50px] sm:min-h-[56px] px-8 xs:px-10 sm:px-12 py-3 xs:py-3.5 sm:py-4 text-[13px] xs:text-sm sm:text-base bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-black uppercase tracking-widest rounded-md hover:from-yellow-400 hover:to-yellow-500 active:opacity-80 shadow-lg shadow-yellow-500/20 transition-all"
                    >
                        OPEN CONTACT FORM →
                    </MagneticButton>
                </motion.div>
