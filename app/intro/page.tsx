...
export default function IntroPage() {
    ...
    return (
        /* --- CINEMATIC INTRO DISABLED FOR VIDEO INTEGRATION ---
           --- PRESERVED FOR LOW-END DEVICE FALLBACK ---
        ...
        */
        <div className="flex h-screen w-full items-center justify-center bg-black">
            <p className="text-zinc-800 text-xs tracking-widest uppercase animate-pulse">
                System Initializing...
            </p>
        </div>
    );
